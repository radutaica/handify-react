      ...
      >
        <View style={[styles.content, { paddingTop: insets.top + 20 }]}>
          ...
          <View style={styles.form}>
            ...
            >
              <LinearGradient
                colors={loading || !agreeToTerms ? [colors.gray[400], colors.gray[400]] : colors.primary.gradient}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
            ...
            <View style={styles.socialButtons}>
              ...
              <TouchableOpacity style={styles.socialButton} activeOpacity={0.8}>
                ...
                <Text style={[styles.socialButtonText, styles.socialButtonText]}>Continue with Apple</Text>
              </TouchableOpacity>
            </View>
